...
func validatePackageManifestConfig(ctx context.Context, scheme *runtime.Scheme, config *manifestsv1alpha1.PackageManifestSpecConfig, fldPath *field.Path) field.ErrorList {
